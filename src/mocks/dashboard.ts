...
export const statCards: StatCard[] = [
  ...
  },
  {
    title: 'PRs Aprovados',
    value: 10,
    change: '+20% Em relação ao mês passado',
    icon: Check,
  },
  {
    title: 'PRs Reprovados',
    value: 5,
    change: '+17% Em relação ao mês passado',
    icon: Minus,
  },
...
export const recentPRs: PullRequest[] = [
  ...
  {
    id: 23,
    title: 'resolve login validation bug',
    author: 'Paulo Andrade',
    status: 'Aprovado',
  },
  {
    id: 22,
    title: 'correct API response handling',
